...
deg_sig <- results[results$adj.P.Val < 0.05, ]
cat("Significant DEGs (FDR < 0.05):", nrow(deg_sig), "\n")

# These genes may be biologically interesting, even if not FDR significant
